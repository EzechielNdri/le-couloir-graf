...
- **Affichage des documents** :
  - Liste des PDF par section
  - Liens directs pour ouvrir ou télécharger les fichiers
- **Interface responsive** : design moderne, compatible desktop et mobile.
- **Évolutivité** : possibilité d’intégrer ultérieurement des frameworks CSS (Bootstrap, Tailwind, Bulma, Materialize, Animate.css) pour enrichir la mise en page, si nécessaire.
